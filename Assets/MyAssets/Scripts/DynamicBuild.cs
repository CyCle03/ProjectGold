...
public class DynamicBuild : BuildInterface
{
    ...
    public override void CreateListSlots()
    {
        ...
        for (int i = 0; i < buildList.GetListSlots.Length; i++)
        {
            ...
            AddEvent(obj, EventTriggerType.BeginDrag, delegate { OnListDragStart(obj); });
            AddEvent(obj, EventTriggerType.EndDrag, delegate { OnListDragEnd(obj); });
            AddEvent(obj, EventTriggerType.Drag, delegate { OnListDrag(obj); });
